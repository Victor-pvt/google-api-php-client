...
use AppBundle\GoogleMyBusiness\Model\Google_Service_MyBusiness_AssociateLocationRequest;
use AppBundle\GoogleMyBusiness\Model\Google_Service_MyBusiness_MybusinessEmpty;
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_BatchGetLocationsRequest;
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_BatchGetLocationsResponse;
use AppBundle\GoogleMyBusiness\Model\Google_Service_MyBusiness_ClearLocationAssociationRequest;
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_Location;
use AppBundle\GoogleMyBusiness\Model\Google_Service_MyBusiness_FetchVerificationOptionsRequest;
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_FetchVerificationOptionsResponse;
use AppBundle\GoogleMyBusiness\Model\Google_Service_MyBusiness_FindMatchingLocationsRequest;
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_FindMatchingLocationsResponse;
use AppBundle\GoogleMyBusiness\Model\Google_Service_MyBusiness_GoogleUpdatedLocation;
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_ListLocationsResponse;
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_ReportLocationInsightsRequest;
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_ReportLocationInsightsResponse;
use AppBundle\GoogleMyBusiness\Model\Google_Service_MyBusiness_TransferLocationRequest;
use AppBundle\GoogleMyBusiness\Model\Google_Service_MyBusiness_VerifyLocationRequest;
use AppBundle\GoogleMyBusiness\Model\Google_Service_MyBusiness_VerifyLocationResponse;
...
class Google_Service_MyBusiness_AccountsLocations_Resource extends Google_Service_Resource
{
    ...
    public function associate($name, Google_Service_MyBusiness_AssociateLocationRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('associate', array($params), "\\AppBundle\\GoogleMyBusiness\\Model\\Google_Service_MyBusiness_MybusinessEmpty");
    }
    ...
    public function batchGet($name, Google_Service_MyBusiness_BatchGetLocationsRequest $postBody, $optParams = array())
    {
        $params = array('name' => $name, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('batchGet', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_BatchGetLocationsResponse");
    }
    ...
    public function clearAssociation($name, Google_Service_MyBusiness_ClearLocationAssociationRequest $postBody, $optParams = array())
    {
        $params = array('name' => $name, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('clearAssociation', array($params), "\\AppBundle\\GoogleMyBusiness\\Model\\Google_Service_MyBusiness_MybusinessEmpty");
    }
    ...
    public function create($parent, Google_Service_MyBusiness_Location $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('create', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_Location");
    }
    ...
    public function delete($name, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('delete', array($params), "\\AppBundle\\GoogleMyBusiness\\Model\\Google_Service_MyBusiness_MybusinessEmpty");
    }
    ...
    public function fetchVerificationOptions($name, Google_Service_MyBusiness_FetchVerificationOptionsRequest $postBody, $optParams = array())
    {
        $params = array('name' => $name, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('fetchVerificationOptions', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_FetchVerificationOptionsResponse");
    }
    ...
    public function findMatches($name, Google_Service_MyBusiness_FindMatchingLocationsRequest $postBody, $optParams = array())
    {
        $params = array('name' => $name, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('findMatches', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_FindMatchingLocationsResponse");
    }
    ...
    public function get($name, $optParams = array())
    {
        $params = array('name' => $name);
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_Location");
    }
    ...
    public function getGoogleUpdated($name, $optParams = array())
    {
        $params = array('name' => $name);
        $params = array_merge($params, $optParams);
        return $this->call('getGoogleUpdated', array($params), "\\AppBundle\\GoogleMyBusiness\\Model\\Google_Service_MyBusiness_GoogleUpdatedLocation");
    }
    ...
    public function listAccountsLocations($parent, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_ListLocationsResponse");
    }
    ...
    public function patch($name, Google_Service_MyBusiness_Location $postBody, $optParams = array())
    {
        $params = array('name' => $name, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('patch', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_Location");
    }
    ...
    public function reportInsights($name, Google_Service_MyBusiness_ReportLocationInsightsRequest $postBody, $optParams = array())
    {
        $params = array('name' => $name, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('reportInsights', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_ReportLocationInsightsResponse");
    }
    ...
    public function transfer($name, Google_Service_MyBusiness_TransferLocationRequest $postBody, $optParams = array())
    {
        $params = array('name' => $name, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('transfer', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_Location");
    }
    ...
    public function verify($name, Google_Service_MyBusiness_VerifyLocationRequest $postBody, $optParams = array())
    {
        $params = array('name' => $name, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('verify', array($params), "\\AppBundle\\GoogleMyBusiness\\Model\\Google_Service_MyBusiness_VerifyLocationResponse");
    }
}