...
use AppBundle\GoogleMyBusiness\Model\Google_Service_MyBusiness_SearchGoogleLocationsRequest;
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_SearchGoogleLocationsResponse;
/**
...
class Google_Service_MyBusiness_GoogleLocations_Resource extends Google_Service_Resource
{
    ...
    public function search(Google_Service_MyBusiness_SearchGoogleLocationsRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('search', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_SearchGoogleLocationsResponse");
    }
}