...
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_ListAccountAdminsResponse;
/**
...
class Google_Service_MyBusiness_AccountsAdmins_Resource extends Google_Service_Resource
{
    ...
    public function listAccountsAdmins($parent, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_ListAccountAdminsResponse");
    }
