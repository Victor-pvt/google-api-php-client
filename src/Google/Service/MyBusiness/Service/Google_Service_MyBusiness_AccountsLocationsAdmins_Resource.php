...
use AppBundle\GoogleMyBusiness\Collection\Google_Service_MyBusiness_ListLocationAdminsResponse;
...
class Google_Service_MyBusiness_AccountsLocationsAdmins_Resource extends Google_Service_Resource
{
    ...
    public function create($parent, Google_Service_MyBusiness_Admin $postBody, $optParams = array())
    {
        ...
        return $this->call('create', array($params), "\\AppBundle\\GoogleMyBusiness\\Model\\Google_Service_MyBusiness_Admin");
    }
    ...
    public function listAccountsLocationsAdmins($parent, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), "\\AppBundle\\GoogleMyBusiness\\Collection\\Google_Service_MyBusiness_ListLocationAdminsResponse");
    }
    ...
    public function patch($name, Google_Service_MyBusiness_Admin $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('patch', array($params), "\\AppBundle\\GoogleMyBusiness\\Model\\Google_Service_MyBusiness_Admin");
    }
}
